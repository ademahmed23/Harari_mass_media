...
class ChefController extends Controller
{
    ...
    {
        $this->middleware(['permission:chef index,admin'])->only('index');
        $this->middleware(['permission:chef create,admin'])->only(['create', 'store']);
        $this->middleware(['permission:chef update,admin'])->only(['edit', 'update']);
        $this->middleware(['permission:chef delete,admin'])->only(['destroy']);
    }
