...
<head>
    ...
    <link href="{{ asset('frontend/assets/css/styles1.css') }}" rel="stylesheet">
    {{-- <link href="{{ asset('build/assets/app-9c14562b.css') }}" rel="stylesheet"> --}}
    <style>
        :root {
...
<body>
    ...
    {{-- <script type="text/javascript" src="{{ asset('frontend/assets/js/bootstrap-iconpicker.bundle.min.js') }}"></script> --}}
    {{-- <script type="text/javascript" src="{{ asset('frontend/assets/js/Font-Awesome.js') }}"></script> --}}
